...
for ($i = $msearch_results['start_from']; $i < $msearch_results['start_from'] + $msearch_results['limit']; $i++)
{
    ...
    {    
        ...
        <td align = "center">
        <p><a href = "http://www.cisite.ru/materials/{$msearch_results[$i][0]}"><img class="small_img" src="{$msearch_results[$i][3]}" width="45" height="45"></a></p>
        </td>
        
        <td align = "center">
        <p class = "anons_title"><a href = "http://www.cisite.ru/materials/{$msearch_results[$i][0]}">{$msearch_results[$i][1]}</a></p>
